                        ...
                        {images.map((img) => (
                            <div key={img.id} className="relative z-10 hover:z-50 shrink-0 flex-[0_0_auto] mr-6 sm:mr-10">
                                ...
                                <div
                                    ...
                                    className={`relative flex-none w-[280px] sm:w-[350px] aspect-square rounded-[2rem] overflow-hidden shadow-sm transition-all duration-500 hover:scale-105 cursor-pointer ${dark ? 'border border-white/20 bg-black/20 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]' : 'bg-white/40 border border-gray-100 hover:shadow-[0_0_25px_rgba(0,51,160,0.3)]'}`}
                                >
                                    <Image
                                        src={img.src}
