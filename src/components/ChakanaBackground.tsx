  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute inset-[-500px] opacity-[0.05]"
        style={{
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#fdfbf7]/10 via-transparent to-[#fdfbf7]/10" />
    </div>
  );
}
